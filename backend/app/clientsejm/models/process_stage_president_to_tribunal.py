...
T = TypeVar("T", bound="ProcessStagePresidentToTribunal")


@_attrs_define
class ProcessStagePresidentToTribunal:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_president_to_tribunal = cls(
        ...
        process_stage_president_to_tribunal.additional_properties = d
        return process_stage_president_to_tribunal
