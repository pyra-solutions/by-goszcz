...
T = TypeVar("T", bound="ProcessStagePresidentMotionConsideration")


@_attrs_define
class ProcessStagePresidentMotionConsideration:
    """Consideration of the President's motion on the Sejm sitting
    ...
    Attributes:
        ...
        decision (str | Unset): the Sejm decision Example: nie dokończone rozpatrywanie stanowiska Senatu.
        comment (str | Unset): a comment Example: MS przeniosła głosowanie na następne posiedzenie Sejmu.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_president_motion_consideration = cls(
        ...
        process_stage_president_motion_consideration.additional_properties = d
        return process_stage_president_motion_consideration
