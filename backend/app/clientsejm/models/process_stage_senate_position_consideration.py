...
T = TypeVar("T", bound="ProcessStageSenatePositionConsideration")


@_attrs_define
class ProcessStageSenatePositionConsideration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_senate_position_consideration = cls(
        ...
        process_stage_senate_position_consideration.additional_properties = d
        return process_stage_senate_position_consideration
