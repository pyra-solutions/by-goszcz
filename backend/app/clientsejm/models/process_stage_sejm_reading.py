...
T = TypeVar("T", bound="ProcessStageSejmReading")


@_attrs_define
class ProcessStageSejmReading:
    ...
    Attributes:
        ...
        sitting_num (int | Unset): Sejm sitting number Example: 77.
        comment (str | Unset): comment Example: przez aklamację.
        decision (str | Unset): decision Example: podjęto uchwałę.
        text_after_3 (str | Unset): a link to a text after third reading (in a PDF format) Example:
            https://api.sejm.gov.pl/sejm/term10/processes/241/attachment/241_u3.pdf.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        text_after_3 = self.text_after_3
        ...
        if text_after_3 is not UNSET:
            field_dict["textAfter3"] = text_after_3
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_after_3 = d.pop("textAfter3", UNSET)

        stage_type = d.pop("stageType", UNSET)

        process_stage_sejm_reading = cls(
            ...
            comment=comment,
            decision=decision,
            text_after_3=text_after_3,
            stage_type=stage_type,
        )

        process_stage_sejm_reading.additional_properties = d
        return process_stage_sejm_reading
