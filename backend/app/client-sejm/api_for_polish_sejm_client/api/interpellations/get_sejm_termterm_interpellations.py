...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/sejm/term{term}/interpellations".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> list[Interpellation] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = Interpellation.from_dict(response_200_item_data)
