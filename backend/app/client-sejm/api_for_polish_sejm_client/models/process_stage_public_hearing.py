...
T = TypeVar("T", bound="ProcessStagePublicHearing")


@_attrs_define
class ProcessStagePublicHearing:
    """public hearing
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_public_hearing = cls(
        ...
        process_stage_public_hearing.additional_properties = d
        return process_stage_public_hearing
