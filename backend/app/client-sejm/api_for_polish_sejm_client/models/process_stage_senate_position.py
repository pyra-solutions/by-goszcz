...
T = TypeVar("T", bound="ProcessStageSenatePosition")


@_attrs_define
class ProcessStageSenatePosition:
    """the Senate position
    ...
    Attributes:
        ...
        position (str | Unset): the Senate position Example: wniósł poprawki.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_senate_position = cls(
        ...
        process_stage_senate_position.additional_properties = d
        return process_stage_senate_position
