...
T = TypeVar("T", bound="ProcessStageToPresident")


@_attrs_define
class ProcessStageToPresident:
    """act forwarded to the President for signature
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_to_president = cls(
        ...
        process_stage_to_president.additional_properties = d
        return process_stage_to_president
