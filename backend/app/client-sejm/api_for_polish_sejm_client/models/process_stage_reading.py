...
class ProcessStageReading:
    ...
    Attributes:
        ...
        continued_on (list[datetime.date] | Unset): reading continued on
    ...
    continued_on: list[datetime.date] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        continued_on: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        continued_on: list[datetime.date] | Unset = UNSET
        if _continued_on is not UNSET:
            continued_on = []
            for continued_on_item_data in _continued_on:
