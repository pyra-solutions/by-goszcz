...
T = TypeVar("T", bound="ProcessStageStart")


@_attrs_define
class ProcessStageStart:
    """process start
    ...
    Attributes:
        ...
        print_number (str | Unset): print number Example: 248.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_start.additional_properties = d
        return process_stage_start
