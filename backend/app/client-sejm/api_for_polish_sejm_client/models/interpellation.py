...
T = TypeVar("T", bound="Interpellation")
...
class Interpellation:
    ...
    Attributes:
        ...
        repeated_interpellation (list[Interpellation] | Unset): a list of interpellations that were submitted after
            reciving unsatisfactory answer (request for additional explanations)
    """
    ...
    repeated_interpellation: list[Interpellation] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        repeated_interpellation: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.repeated_interpellation, Unset):
            repeated_interpellation = []
            for repeated_interpellation_item_data in self.repeated_interpellation:
                repeated_interpellation_item = repeated_interpellation_item_data.to_dict()
                repeated_interpellation.append(repeated_interpellation_item)
        ...
        if repeated_interpellation is not UNSET:
            field_dict["repeatedInterpellation"] = repeated_interpellation
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _repeated_interpellation = d.pop("repeatedInterpellation", UNSET)
        repeated_interpellation: list[Interpellation] | Unset = UNSET
        if _repeated_interpellation is not UNSET:
            repeated_interpellation = []
            for repeated_interpellation_item_data in _repeated_interpellation:
                repeated_interpellation_item = Interpellation.from_dict(repeated_interpellation_item_data)
        ...
        interpellation = cls(
            ...
            repeated_interpellation=repeated_interpellation,
        )

        interpellation.additional_properties = d
