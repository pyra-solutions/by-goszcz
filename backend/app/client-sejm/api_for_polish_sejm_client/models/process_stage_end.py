...
T = TypeVar("T", bound="ProcessStageEnd")


@_attrs_define
class ProcessStageEnd:
    ...
    Attributes:
        ...
        comment (str | Unset): a comment Example: Trybunał Konstytucyjny orzekł przed podpisaniem ustawy przez
            Prezydenta jej niezgodność z Konstytucją.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_end.additional_properties = d
        return process_stage_end
