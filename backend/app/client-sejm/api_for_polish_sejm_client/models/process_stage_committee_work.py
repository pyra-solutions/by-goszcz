...
T = TypeVar("T", bound="ProcessStageCommitteeWork")


@_attrs_define
class ProcessStageCommitteeWork:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_committee_work = cls(
        ...
        process_stage_committee_work.additional_properties = d
        return process_stage_committee_work
