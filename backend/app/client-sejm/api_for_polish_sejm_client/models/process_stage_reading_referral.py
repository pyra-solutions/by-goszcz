...
T = TypeVar("T", bound="ProcessStageReadingReferral")


@_attrs_define
class ProcessStageReadingReferral:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_stage_reading_referral = cls(
        ...
        process_stage_reading_referral.additional_properties = d
        return process_stage_reading_referral
