...
@Component({
  selector: 'legislative-timeline',
  templateUrl: './legislative-timeline.component.html',
  styleUrls: ['./legislative-timeline.component.scss'],
  standalone: false,
})
export class LegislativeTimeline implements OnInit {
  projects: Project[] = [];
